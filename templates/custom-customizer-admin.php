<?php
$currentOptions = get_option('custom_customizer_options') ?? [];
    ...
    foreach ($currentOptions as $customizerOption) : ?>
        <div class="cc-rows" id="row-<?php echo $counter ?>">
            ...
            <select class="cc-rows__select" id="select-input-<?php echo $counter ?>" name="select-name-<?php echo $counter ?>">
                ...
                <option id="option-5" value="TextArea" <?php checkIfSelected("TextArea", $customizerOption[0]); ?>>TextArea</option>
                <option id="option-6" value="MediaUploader" <?php checkIfSelected("MediaUploader", $customizerOption[0]); ?>>MediaUploader</option>
            </select>
